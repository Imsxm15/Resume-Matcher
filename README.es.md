...
- **Impulsado por OpenAI**: Usa tu propia clave de API de OpenAI; todas las solicitudes van directamente desde tu entorno a la API de OpenAI.
...
- API de OpenAI para la inferencia del modelo.
...
| Python       | 3.12+                                         |
| Next.js      | 15+                                           |
| API de OpenAI | Última (configurable)                         |
